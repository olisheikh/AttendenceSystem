...
<div class="container-full">
		...
		<section class="content">
			...
			<div class="box-header with-border">
			  <h4 class="box-title">User Profile Edit</h4>
					  ...
					  <div class="row">
						<div class="col-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                <img id="showImage" src="{{ (!empty($editData->profile_photo_path)) ? url('upload/user_images/'.$editData->profile_photo_path) : url('upload/user_default_profile_image.png') }}" alt="" style="width:100px;height:100px;">
