...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="text-center p-3 mb-2 bg-dark text-white">
        <h1 class="text-primary">Automatic Attendance system using Face Recognition
</h1>
        <br><br>
        ...
        <div class="mx-auto" style="width: 200px;">
            @if (Route::has('login'))
                <div >
                    ...
                    @auth
                        <a href="{{ url('/login') }}" class="text-primary underline" >Dashboard</a>
                    @else
                        <a href="{{ route('login') }}" class="text-primary underline ">Log in</a>
<br>
                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="text-primary underline">Register</a>
                        @endif
                    @endauth
                </div>
            @endif
